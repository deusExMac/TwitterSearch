...
``encryptionKeyFile``: Path to the local file containing the secret-key required to decrypt the encrypted bearer tokens. This file should never be shared. For more information on this file see [TwitterAPI section of the configuration file]($twitterAPI)
